...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <s:form id="form" action="role_add" method="post" theme="simple">
           <table class="table-edit"  width="95%" align="center">
	           	...
	           	<tr>
	           		...
	           		<td>
	           			...
	           			<s:textfield name="roleName" id="roleName" cssClass="easyui-validatebox" data-options="required:true" value="%{model.roleName}"></s:textfield>
	           		</td>
					<td>默认功能:</td><td>
						<s:textfield name="defFunc" id="defFunc" cssClass="easyui-validatebox" value="%{model.defFunc}"></s:textfield>
					</td>
				</tr>
				<tr>
	           		<td>备注:</td>
